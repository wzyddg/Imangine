...
<body>
	...
	<%
		...
		List<Albums> albums = DBQuerrier.getAlbumsWithSetterIdNIndex(
				userLoginStatus.getUserId(), pageNum);

		if (albums.size() == 0 && pageNum > 0) {
			response.sendRedirect("album-my.jsp?page=" + (pageNum - 1));
		}
	%>
			...
			<div class="blog-posts-section">
				...
				<div class="blog-post-grids blog_grids">
					...
					<div class="pagination text-center">
						<ul>
							<li><a class="prev"
								href="album-my.jsp?page=<%=(pageNum > 0 ? pageNum - 1 : 0)%>">＜Prev</a></li>
							<li><%=pageNum + 1%></li>
							<li><a class="next"
								href="album-my.jsp?page=<%=pageNum + 1%>">Next＞</a></li>
						</ul>
					</div>
				</div>
			</div>
