...
<body>
	...
	<%
		...
		List<Pictures> pics = DBQuerrier.getPicsWithPosterIdNIndex(
				userLoginStatus.getUserId(), pageNum);

		if (pics.size() == 0 && pageNum > 0) {
			response.sendRedirect("blog.jsp?page=" + (pageNum - 1));
		}
	%>
	<div class="content">
		<div class="container">
			<div class="blog-posts-section">
				...
				<h4 class="head">
					<a href="blog.jsp">My Picture</a><span class="line"></span>
				</h4>
				...
				<div class="blog-post-grids blog_grids">
					...
					<div class="col-md-4 blog-posts">
						...
						<div class="col-md-4 blog-posts span_66">
							...
							<div class="blog-post">
								...
								<p class="sub_head">
									Posted by <a href="#"><%=userLoginStatus.getUserName()%></a> on
					...
					<div class="pagination text-center">
						<ul>
							<li><a class="prev"
								href="blog.jsp?page=<%=(pageNum > 0 ? pageNum - 1 : 0)%>">＜Prev</a></li>
							<li><%=pageNum + 1%></li>
							<li><a class="next" href="blog.jsp?page=<%=pageNum + 1%>">Next＞</a></li>
						</ul>
					</div>
				</div>
			</div>
