...
<body>
	...
	<%
		...
		List<Pictures> pics = DBQuerrier.getMomentSharePicsWithIndex(pageNum*2);

		if (pics.size() == 0 && pageNum > 0) {
			response.sendRedirect("sharing-moment.jsp?page=" + (pageNum - 1));
		}
	%>
	...
	<div class="content">
		<div class="container">
			<div class="projects-section">
				<h4 class="head">
					<a href="sharing-moment.jsp">Moment Sharing</a><span class="line"></span>
				</h4>
				...
				<div class="row">
					...
					<div class="pagination text-center">
						<ul>
							<li><a class="prev"
								href="sharing-moment.jsp?page=<%=(pageNum > 0 ? pageNum - 1 : 0)%>">＜Prev</a></li>
							<li><%=pageNum + 1%></li>
							<li><a class="next"
								href="sharing-moment.jsp?page=<%=pageNum + 1%>">Next＞</a></li>
						</ul>
					</div>
